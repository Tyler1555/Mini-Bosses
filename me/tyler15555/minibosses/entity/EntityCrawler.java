...
public class EntityCrawler extends EntityMob {
	...
	protected void applyEntityAttributes() {
		...
		this.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.attackDamage).setBaseValue(140.0D);
		this.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.maxHealth).setBaseValue(10D);
